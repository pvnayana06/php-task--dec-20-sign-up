...
$nameErr = $emailErr = $passwordErr = $mobileErr = $addressErr = $zipErr = $genderErr = "";  
$name = $email = $password = $mobileno = $address = $zip = $gender =  ""; 
    ...
    else
    {
        $password= input_data($_POST['password']);
             if (preg_match("#.*^(?=.{8,20})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).*$#", $password))
               {
                $passwordErr = "Your password is good.";
                    } else 
                    {
                        $passwordErr = "Your password is bad.";
                    }
    }
...
<table>
   <tr>
    ...
    <tr>
       <td>Address: </td>
       <td><textarea name="address" rows="5" cols="30"></textarea>  
        <span class="error">* 
           <?php echo $addressErr; ?> 
        </span>  <br>  
        </td>
...
<?php  
    ...
    {  
          if($nameErr == "" && $emailErr == "" && $passwordErr == "" && $mobileErr == "" && $addressErr == "" && $zipErr == "" && $genderErr == "") 
           {  
